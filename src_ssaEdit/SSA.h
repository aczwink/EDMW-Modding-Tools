 ...
 * http://wiki.xentax.com/index.php?title=Empires_SSA
*/


#define SSA_SIGNATURE 0x73736172
#define SSA_VERSION_MAJOR 1
#define SSA_VERSION_MINOR 0
#define SSA_HEADER_SIZE 16